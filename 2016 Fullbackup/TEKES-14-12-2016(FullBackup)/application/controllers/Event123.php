...
class Event extends CI_Controller {
    ...
    public function Index() {
        ...
        $msg = "Hi,<br>"
                . "<p style='text-indent:50px'>These are the below employee are applied leave and applied date crossed 24 hours kindly check the TEKES software http://192.168.10.100:1234/TEKES/ for more info.</p></b>"
