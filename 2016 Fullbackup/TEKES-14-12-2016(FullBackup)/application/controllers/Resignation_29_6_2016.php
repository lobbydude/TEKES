...
class Resignation extends CI_Controller {
    ...
    public function add_resignation() {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $msg = "Dear Sir,<br>"
                    . "<p style='text-indent:60px'>I am writing this letter of resignation to formally notify you of my decision to resign from the post of $designation_name with $company_name. I have taken this decision after through deliberation and assessment and I believe it is in my best interest to move on.</p>"
