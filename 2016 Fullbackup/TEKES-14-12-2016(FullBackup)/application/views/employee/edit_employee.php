                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="tab1">
                                    <form id="editemployeebasic_form" method="post" action="" class="validate">
                                        ...
                                        <?php if (($user_role == 2) || ($current_user == $emp_no) || $user_role == 6 || $user_role == 4) {
                                            ?>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="round" name="attach_type" id="attach_type" data-validate="required" data-message-required="Please select type." onchange="others(this.value)">
                                                        ...
                                                        <option value="Relieving letter 1">Relieving letter 1</option>
<option value="Relieving letter 2">Relieving letter 2</option>
<option value="Relieving letter 3">Relieving letter 3</option>
