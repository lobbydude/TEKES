            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (msg == 'success') {
                        ...
                        // $('#edit_lang_table tr:last').after('<tr><td>' + lang_name + '</td><td>' + lang_read + '</td><td>' + lang_speak + '</td><td>' + lang_write + '</td></tr>');
                    }
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (msg == 'success') {
                        ...
                        // $.noConflict();
                        //     }, 500);
                        // $('#edit_family_table tr:last').after('<tr><td>' + family_member_name + '</td><td>' + family_member_dob + '</td><td>' + family_member_age + '</td><td>' + family_member_relationship + '</td><td>' + gender + '</td><td>' + family_member_occupation + '</td></tr>');
                    }
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (msg == 'success') {
                        ...
                        // $.noConflict();
                        //  }, 500);
                        // $('#edit_education_table tr:last').after('<tr><td>' + qualification + '</td><td>' + university_name + '</td><td>' + college_name + '</td><td>' + major_subject + '</td><td>' + marks + '</td><td>' + year_of_passing + '</td></tr>');
                    }
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (msg == 'success') {
                        ...
                        // $.noConflict();
                        //   }, 500);
                        // $('#edit_skill_table tr:last').after('<tr><td>' + skill_name + '</td><td>' + no_of_month + '</td><td>' + training + '</td><td>' + skill_from + '</td><td>' + skill_to + '</td></tr>');
                    }
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (msg == 'success') {
                        ...
                        // }, 500);
                        //  $('#edit_exp_table tr:last').after('<tr><td>' + prev_company_name + '</td><td>' + prev_company_location + '</td><td>' + prev_designation + '</td><td>' + prev_date_joined + '</td><td>' + prev_date_relieved + '</td><td>' + relevant_exp + '</td><td>' + prev_reason_relieving + '</td><td>' + prev_salary + '</td></tr>');
                    }
                        ...
                        if ($user_role == 1) {
                            if ($this->uri->segment(3) == "") {
                                ...
                                <ul>
                                    ...
                                    ?>">
                                        <a href="#tab2" data-toggle="tab"><span><?php
                                                if ($user_role == 3) {
                                                    echo "1";
                                                } else {
                                                    echo "2";
                                                }
                                                ?></span>Personal Details</a>
                                    </li>
                                    <li>
                                        <a href="#tab3" data-toggle="tab"><span><?php
                                                if ($user_role == 3) {
                                                    echo "2";
                                                } else {
                                                    echo "3";
                                                }
                                                ?></span>Family Details</a>
                                    </li>
                                    <li>
                                        <a href="#tab4" data-toggle="tab"><span><?php
                                                if ($user_role == 3) {
                                                    echo "3";
                                                } else {
                                                    echo "4";
                                    ...
                                    <li>
                                        <a href="#tab5" data-toggle="tab"><span><?php
                                                if ($user_role == 3) {
                                                    echo "4";
                                                } else {
                                                    echo "5";
                                                }
                                                ?></span>Work Experience</a>
                                    </li>
                                    <li>
                                        <a href="#tab6" data-toggle="tab"><span><?php
                                                if ($user_role == 3) {
                                                    echo "5";
                                                } else {
                                                    echo "6";
                                    ...
                                    <?php if ($user_role == 3) { ?>
                                        <li>
                                            <a href="#tab8" data-toggle="tab"><span>6</span>Reference</a>
                                        </li>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="tab1">
                                    <form id="editemployeebasic_form" method="post" action="" class="validate">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="birthdate" id="birthdate" class="form-control datepicker" data-format="dd-mm-yyyy" data-validate="required" data-message-required="Please select birth date." value="<?php echo $dob; ?>">
                                                        <div class="input-group-addon">
                                                            <a href="#"><i class="entypo-calendar"></i></a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class='row'>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="blood_group" id="blood_group" class="round" data-validate="required" data-message-required="Please select blood group.">
                                        ...
                                        <?php if (($user_role == 2) || ($current_user == $emp_no)) {
                                            ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="reporting_to" id="reporting_to" class="round" data-validate="required" data-message-required="Please select reporting manager.">
                                                        ...
                                                        <?php foreach ($select_report_exp->result() as $row_report_exp) { ?>
                                                            <option value="<?php echo $row_report_exp->Emp_Number; ?>"><?php echo $row_report_exp->Emp_FirstName . '- ' . $emp_code . $row_report_exp->Emp_Number; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="family_member_dob" id="family_member_dob" class="form-control datepicker" data-format="dd-mm-yyyy" onchange="getAge(this.value)">
                                                        <div class="input-group-addon">
                                                            <a href="#"><i class="entypo-calendar"></i></a>
                                                        </div>
                                                    </div>
                                ...
                                <div class="tab-pane" id="tab6">
                                    ...
                                    <form id="editemployeeinfo_form" method="post" class="validate">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="aadhar_no" id="aadhar_no" placeholder="Aadhar Card No"  value="<?php echo $Emp_Aadharcard; ?>"/>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="control-label">Differently Abled</label>
                                                    <input class="form-control" name="differently_abled" id="differently_abled" placeholder="Differently Abled" value="<?php echo $Differently_abled; ?>"/>
                                                </div>
                                            </div>
                                            ...
                                            <tbody>
                                                ...
                                                if ($count_document > 0) {
                                                    foreach ($select_document->result() as $row_document) {
                                                        ...
                                                        $file_url = "http://1.23.211.173/DRNHRMS/upload/";
                                                        ?>
                                                        <tr>
                                ...
                                <div class="tab-pane" id="tab9">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label"><b>Mother Tongue : </b></label>
                                                <?php echo $Emp_Mother_Tongue; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label" for="birthdate"><b>Date of Birth : </b></label>
                                                <?php echo $dob; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label" for="birthdate"><b>Actual Date of Birth : </b></label>
                                                <?php echo $actual_dob; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <?php echo $Emp_Contact; ?>
                                            </div>
                                        </div>

                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label"><b>Alternate Number : </b></label>
                                                <?php echo $Emp_AlternateContact; ?>
                                            </div>
                                        </div>

                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label"><b>Personal Email Address : </b></label>
                                                <?php echo $Emp_PersonalEmail; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <?php echo $Emp_Permanent; ?>
                                            </div>
                                        </div>

                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label"><b>Temporary Address : </b></label>
                                                <?php echo $Emp_Temporary; ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label"><b>Pan Card No : </b></label>
                                                <?php echo $Emp_PANcard; ?>
                                            </div>
                                        </div>

                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label"><b>Aadhar Card No : </b></label>
                                                <?php echo $Emp_Aadharcard; ?>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label"><b>Name On the Passport : </b></label>
                                                <?php echo $Emp_Passportname; ?>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label"><b>Date of Expiry : </b></label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label"><b>Do you possess any valid visa? </b></label>
                                                <?php
                                                if ($Valid_visa == "No") {
                                                    echo "No";
                                                } else {
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label"><b>Country of Issue : </b></label>
                                                <?php echo $Issue_Country; ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label"><b>Hobbies : </b></label>
                                                <?php echo $Hobbies; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">	
                                            <div class="form-group">
                                                <label class="control-label"><b>Are you related to any of our employees? </b></label>
                                                <?php
                                                if ($related_emp == "Yes") {
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label"><b>Voter ID : </b></label>
                                                <?php echo $voter_id; ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label"><b>Allergic To : </b></label>
                                                <?php echo $Alergic; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label"><b>Differently Abled : </b></label>
                                                <?php echo $Differently_abled; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label"><b>Eye Sight : </b></label>
                                                <?php echo $Eye_Sight; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label"><b>Any Major Illness : </b></label>
                                                <?php echo $Major_Illeness; ?>
                                            </div>
                                        </div>

                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label"><b>Contact Person in case of Emergency : </b></label>
