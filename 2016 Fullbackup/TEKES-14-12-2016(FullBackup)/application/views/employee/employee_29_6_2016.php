                                                ...
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <?php if ($status == 1) { ?>
                                                            ...
                                                            if ($emp_resigned_status == "Resigned") {
                                                                ?>
                                                                <li>
                                                                ...
                                                                ?>
                                                                <li>
                                                                    <a data-toggle='modal' href='#termination_status' onclick="termination_status('<?php echo $emp_no; ?>')">
                                                                        Terminated
                                                                    </a>
                                                                </li>
                                                                <?php
                             ...
                             if ($user_role == 4 || $user_role == 5) {
                                ...
                                foreach ($q->Result() as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $designation_name; ?></td>
                                        <td>
										<?php echo $no_days_Y . " Years, " . $no_days_M . " Months, <br>" . $no_days_D . " Days"; ?>
									</td>
                                        <td>
                                            <?php
                                            if ($emp_mode == "Probation") {
                ...
                <div class="modal-content">
					<div class="modal-header info-bar">
                        <div class="row">
                            ...
                            <!--<div class="col-md-2">
                                <a href="#" class="btn btn-primary" onclick="resignation_print()"><i class="entypo-print"></i>Print</a>
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            </div>-->
							<div class="col-md-2">
                ...
                <div class="modal-content">
					<div class="modal-header info-bar">
                        <div class="row">
                            ...
                            <!--<div class="col-md-2">
                                <a href="#" class="btn btn-primary" onclick="termination_print()"><i class="entypo-print"></i>Print</a>
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            </div>-->
							<div class="col-md-2">
