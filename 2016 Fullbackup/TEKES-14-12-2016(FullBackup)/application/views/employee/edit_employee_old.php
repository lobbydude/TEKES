                                            ...
                                            <tbody>
                                                ...
                                                if ($count_document > 0) {
                                                    foreach ($select_document->result() as $row_document) {
                                                        ...
                                                        $file_url = "http://111.93.245.133/DRNHRMS/upload/";
                                                        ?>
                                                        <tr>
                                    ...
                                    <div id="experience_div">
                                        ...
                                        <form id="editemployeereference_form" method="post" class="validate">
                                            ...
                                            <div class="row">
                                                ...
                                                <?php if ($user_role == 3) { ?>
                                                    <div class="col-md-3" style="margin-top: 20px; margin-left: 175px;">
                                                        <button class="btn btn-primary" type="button" onclick="window.location.href = '<?php echo site_url('Profile') ?>'">Close</button>
                                                    </div>
                                                <?php } ?>
                                            </div>
