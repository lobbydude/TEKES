            ...
            <div class="modal-dialog" style="width:60%">
                <div class="modal-content">
                    ...
                    <div class="modal-header info-bar">
                        ...
                        <h3 class="modal-title">New Client & Sub Process</h3>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="client_name" id="client_name" class="form-control" placeholder="Client" data-validate="required" data-message-required="Please enter client.">
                                    </div>	
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="subdepartment_name" id="subdepartment_name" class="form-control" placeholder="Sub Process" data-validate="required" data-message-required="Please enter sub process.">
                                    </div>	
                                </div>
								<div class="col-md-4">
                                    <div class="form-group">
