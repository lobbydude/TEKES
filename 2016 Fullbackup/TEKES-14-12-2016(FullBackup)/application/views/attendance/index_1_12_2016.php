                ...
                <div class="row">
                    <div class="panel-heading info-bar" >
                        ...
                        <div class="panel-options">
                            ...
                            <div class="col-md-6">
                                <input type="text" id="selected_date" class="form-control datepicker" data-start-view="2" data-format="dd-mm-yyyy" onchange="location = 'http://192.168.10.100:1234/TEKES/Attendance/Index/' + this.value;" value="<?php
                                if ($this->uri->segment(3) != "") {
