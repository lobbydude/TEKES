                            ...
                            if ($user_role == 2 || $user_role == 6) {
                                ...
                                foreach ($q->result() as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $weekend_allowance_payout . "($week_half_day * $saturday_half_day + $week_satfull_day * $saturday_full_day + $week_satnightfull_day * $saturday_night + $week_sunfull_day * $sunday_full_day + $week_sunnightfull_day * $sunday_night + $week_both_day * $both_day + $week_both_night * $both_night)"; ?></td>
