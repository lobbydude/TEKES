            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <table class="table table-bordered stripe row-border order-column" id="timesheet_table">
                        ...
                        // Shift Name Time details End here 
                        //Today Code:                       
                        $data_select = array(
                            'Employee_Id' => $emp_no,
                            //'Date' => $Login_Date,                            
                        ...
                        $this->db->order_by('SA_Id', 'desc');
                        $this->db->where($data_select);
                        $q_shift = $this->db->get('tbl_shift_allocate');
                        foreach ($q_shift->Result() as $row_shift) {
                            $SA_Id = $row_shift->SA_Id;
                            $shift_year = $row_shift->Year;
                            $shift_month1 = $row_shift->Month;
                            $shift_month = date('F', mktime(0, 0, 0, $shift_month1, 10));
                            $date1 = $row_shift->Date;
                            $date = date("d-m-Y", strtotime($date1));
                            $shiftid = $row_shift->Shift_Id;
                        }
                        ?>
                ...
                <table class="table table-bordered">
                    <thead> 
                        <tr>
                            ...
                            <th style="border:1px solid #000;">Shift Name Time</th>
                            <?php
                            for ($i = 1; $i <= $num; $i++) {
                                $mktime = mktime(0, 0, 0, $month, $i, $year);
                                $date = date("d", $mktime);
                                ...
                                $date_n = date("d-m-Y", $mktime);
                                ?>
                                <th style="border:1px solid #000;" colspan="3"><p style="transform: rotate(270deg);"><?php echo "'$date_n"; ?></p></th>
                        <?php
                    }
                    ?>
                    </tr>
                                                        ...
                                                        foreach ($q_in_weekend->result() as $row_in_weekend) {
                                                            ...
                                                            if ($total_hours_weekend > $min_time_weekend) {
                                                                if ($shift_name_weekend == "NIGHT -1" || $shift_name_weekend == "NIGHT -2") {
                                                                    ...
                                                                    echo "$Logout_Time_weekend";
                                                                    echo "</td>";
                                                                    echo "<td style = 'background-color:#002040;color:#fff;border:1px solid #000;text-align:center'>";
                                                                    echo "$total_hours_weekend";
                                                                    echo "</td>";
                                                                }
                                                            } else {
                                                                ...
                                                                echo "$Logout_Time_weekend";
                                                                echo "</td>";
                                                                echo "<td style = 'background-color:#002040;border:1px solid #000;text-align:center'>";
                                                                echo "$total_hours_weekend";
                                                                echo "</td>";
                                                            }
                                                        }
