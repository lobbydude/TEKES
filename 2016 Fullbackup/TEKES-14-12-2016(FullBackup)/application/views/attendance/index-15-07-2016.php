                ...
                <div class="row">
                    <div class="panel-heading info-bar" >
                        ...
                        <div class="panel-options">
                            ...
                            <div class="col-md-6">
                                <input type="text" id="selected_date" class="form-control datepicker" data-start-view="2" data-format="dd-mm-yyyy" onchange="location = 'http://localhost/TEKES1/Attendance/Index/' + this.value;" value="<?php
                                if ($this->uri->segment(3) != "") {
                                ...
                                if ($count_in > 0) {
                                    ...
                                    foreach ($q_in->Result() as $row_in) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php
                                                $shift_grace_time1 = strtotime("+15 minutes", strtotime($Shift_From1));
                                                $shift_grace_time = date('h:i:s', $shift_grace_time1);
                                                if ($shift_grace_time < $Login_Time) {
                                                    echo "<span style='color:red'>$Login_Time</span>";
                                                } else {
                                                    echo $Login_Time;
                                                }
                                                ?>
                                            ...
                                            <td><?php
                                                ...
                                                $total_mins = round(abs($to_time - $from_time) / 60, 2) . " minute";
