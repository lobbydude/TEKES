            ...
            <div id="timesheet_table_download" class="timesheet_table_download" style="display:none">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        for ($si = 1; $si <= $num; $si++) {
                            ?>
                            <th style="border:1px solid #000;">Shift</th>
                            <th style="border:1px solid #000;">S.Login</th>
                            <th style="border:1px solid #000;">S.Logout</th>
                                ...
                                <tr>
                                    ...
                                    for ($i = 1; $i <= $num; $i++) {
                                        ...
                                        if ($count_shift_all == 1) {
                                            ...
                                            echo "<td style = 'background-color:#a95c73;color:#fff;border:1px solid #000;text-align:center'>$Shift_Name</td>";
                                            echo "<td style = 'background-color:#a95c73;color:#fff;border:1px solid #000;text-align:center'>$Shift_From</td>";
                                            echo "<td style = 'background-color:#a95c73;color:#fff;border:1px solid #000;text-align:center'>$Shift_To</td>";
                                        } else {
                                            echo "<td></td>";
                                            echo "<td></td>";
                                            echo "<td></td>";
                                        ...
                                        if ($count_compoff == 1) {
                                            echo "<td style = 'background-color:#00a651;color:#fff;border:1px solid #000;text-align:center' colspan='3'>COMP-OFF</td>";
                                        } else if ($count_lop == 1) {
                                            echo "<td style = 'background-color:#00a651;color:#fff;border:1px solid #000;text-align:center' colspan='3'>LOP</td>";
                                        } else {
                                            $dat_no_1 = date('N', strtotime($date_1));
                                            if ($dat_no_1 == 6 || $dat_no_1 == 7) {
                                                $data_in_weekend = array(
                                                ...
                                                if ($count_in_weekend == 1) {
                                                    ...
                                                    if ($dat_no_1 == 6) {
                                                        echo "<td style = 'background-color:#fad839;border:1px solid #000;text-align:center' colspan='3'>SAT</td>";
                                                    }if ($dat_no_1 == 7) {
                                                        echo "<td style = 'background-color:#fad839;border:1px solid #000;text-align:center' colspan='3'>SUN</td>";
                                                    }
                                                }
                                                $wo = $wo + 1;
                                            } else {
                                                ...
                                                $count_hol = $q_hol->num_rows();
                                                if ($count_hol == 1) {
                                                    echo "<td style = 'background-color:#0072bc;color:#fff;border:1px solid #000;text-align:center' colspan='3'>H</td>";
                                                    $h = $h + 1;
                                                } else {
                                                    $data_in = array(
                                                        'Emp_Id' => $employee_no,
                                                    ...
                                                    if ($count_in == 1) {
                                                        ...
                                                        echo "<td style = 'background-color:#d42020;color:#fff;border:1px solid #000;text-align:center' colspan='3'>A</td>";
                                                    }
                                                }
                                            }
                                        }
                                    ...
                                    <tr>
                                        ...
                                        for ($i = 1; $i <= $num; $i++) {
                                            ...
                                            if ($count_shift_all == 1) {
                                                ...
                                                echo "<td style = 'background-color:#a95c73;color:#fffborder:1px solid #000;text-align:center'>$Shift_Name</td>";
                                                echo "<td style = 'background-color:#a95c73;color:#fffborder:1px solid #000;text-align:center'>$Shift_From</td>";
                                                echo "<td style = 'background-color:#a95c73;color:#fffborder:1px solid #000;text-align:center'>$Shift_To</td>";
                                            } else {
                                                echo "<td></td>";
                                                echo "<td></td>";
                                                echo "<td></td>";
                                            ...
                                            if ($count_compoff == 1) {
                                                echo "<td style = 'background-color:#58FAD0;color:#000;border:1px solid #000;text-align:center' colspan='3'>COMP-OFF</td>";
                                            } else if ($count_lop == 1) {
                                                echo "<td style = 'background-color:#BF00FF;color:#fff;border:1px solid #000;text-align:center' colspan='3'>LOP</td>";
                                            } else if ($count_dislop == 1) {
                                                echo "<td style = 'background-color:#BF00FF;color:#fff;border:1px solid #000;text-align:center' colspan='3'>Disciplinary LOP</td>";
                                            } else {
                                                $dat_no_1 = date('N', strtotime($date_1));
                                                if ($dat_no_1 == 6 || $dat_no_1 == 7) {
                                                    $data_in_weekend = array(
                                                    ...
                                                    if ($count_hol == 1) {
                                                        ...
                                                        if ($count_in == 1) {
                                                            ...
                                                            echo "<td style = 'background-color:#d42020;color:#fff;border:1px solid #000;text-align:center' colspan='2'>A</td>";
                                                        }
                                                    }
                                                }
                                            }
