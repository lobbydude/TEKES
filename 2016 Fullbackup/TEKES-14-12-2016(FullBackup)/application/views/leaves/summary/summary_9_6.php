                ...
                <div class="row">
                    ...
                    <table class="table table-bordered datatable" id="summary_table">
                        ...
                        <th rowspan="2"><p>Employee Name</p></th>
						 <th rowspan="2"><p>No Of Days</p></th>
                        <th colspan="<?php echo $count_leave_type; ?>" style="text-align: center">Entitled Leave</th>
                        <th colspan="<?php echo $count_leave_type; ?>" style="text-align: center">Leave Taken</th>
                        <th colspan="<?php echo $count_leave_type; ?>" style="text-align: center">Balance Leave</th>
						<th rowspan="2"><p class='vertical-align-leave'>Accumulation</p></th>
						<th rowspan="2"><p class='vertical-align-leave'>Bal. Accumulation</p></th>
                        <th rowspan="2"><p class='vertical-align-leave'>LOP Deducted</p></th>
                        <th rowspan="2"><p class='vertical-align-leave'>Yet to Deduct LOP</p></th>
                        <th rowspan="2"><p class='vertical-align-leave'>Disciplinary LOP</p></th>
                        <th rowspan="2"><p class='vertical-align-leave'>Comp Off</p></th>
                        <?php if ($user_role == 2 || $user_role == 6) { ?>
                        ...
                        <tr>
                            ...
                            for ($no = 1; $no < 4; $no++) {
                                foreach ($q_leave_type->result() as $row_leave_type) {
                                    ...
                                    ?>
                                    <th><p class='vertical-align-leave'><?php echo $leavetype_title; ?></p></th>
                                    <?php
                                }
                            }
                            ?>
