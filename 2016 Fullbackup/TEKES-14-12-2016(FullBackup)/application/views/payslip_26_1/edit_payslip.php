                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <div id="editpayslipinfo_success" class="alert alert-success" style="display:none;">Payslip details update successfully.</div>
                            ...
                            <div class="row">    
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="edit_payslipinfo_salaryarrears" id="edit_payslipinfo_salaryarrears" class="form-control" data-validate="required,number" data-message-required="Please enter salary arrears." value="<?php echo $salary_arrears; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
