...
<script>
    $(document).ready(function () {
        $('#resignation_status_form').submit(function (e) {
            ...
            var formdata = {
               ...
               // short_notice_date:$('#short_notice_date').val(),
                exit_by: $('#exit_by').val()
    ...
    function short_noticeperiod(lwd, resigned_date, actual_notice_period) {
        ...
        if (actual_notice_period > days) {
            document.getElementById('short_notice_period').value = days;
        } else {
    ...
    <div class="row">
     ...
     <?php if ($user_role == 2 || $user_role == 6) { ?>
        ...
        <div class="row">
			...
			<div class="col-md-4">
                <div class="form-group">
                    <label class="control-label">Full & Final Settlement : </label>
