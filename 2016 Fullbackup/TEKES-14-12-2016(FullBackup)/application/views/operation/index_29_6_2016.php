                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6" style="padding-right:0px">
                                            <div class="tile-title tile-gray">
                                                <div class="icon">
                                                    <a href="http://orders.titlelogy.com" target="_blank" title="Titlelogy"><img src="images/titlelogy.png" width="70" height="70"  title="Titlelogy"></a>
                                                </div>
                                                <div class="title center">
                                                    <h3 style="background-color:#1f5069;color:#fff"><a href="http://orders.titlelogy.com" target="_blank" style="background-color:#1f5069;color:#fff" title="Titlelogy">Titlelogy</a></h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="panel-body">                        
                                ...
                                if ($user_role_id == 2 || $user_role_id == 6) {
                                    ...
                                    <ul class="country-list">
										...
										<li><a href="<?php echo site_url("Leaves/compoff"); ?>"><i class="entypo-sound"></i><b> Comp Off </b></a><?php if ($comp_off_leave_count > 0) { ?><span class="badge badge-secondary chat-notifications-badge"><?php echo $comp_off_leave_count; ?></span><?php } ?></li>
                    ...
                    <div class="col-md-3" id="current_month_div">
                        <div class="sorted ui-sortable">
                            <div data-collapsed="0" class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                      <ul class="current_month" id="current_month_scroll" style="overflow-x: hidden;">
                                            <?php
                    ...
                    <div class="col-md-3" id="current_year_div" style="display:none;">
                        <div class="sorted ui-sortable">
                            <div data-collapsed="0" class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                        <ul class="current_month" id="current_year_scroll" style="overflow-x: hidden;">
                                            <?php
                                            if ($announcement_count > 0) {
