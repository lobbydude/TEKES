                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="report_type" id="report_type" class="round" data-validate="required" data-message-required="Please select type." onchange="show_field()">
                                    <option value="">Please Select</option>
                        ...
                        <div id="calender_div" style="display: none">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label" for="birthdate">Period From</label>
                                    <div class="input-group">
                                        <input type="text" name="period_from" id="period_from" class="form-control datepicker" data-validate="required"  data-format="dd-mm-yyyy" data-message-required="Please select date.">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="period_to" id="period_to" class="form-control datepicker" data-format="dd-mm-yyyy" data-validate="required"  data-message-required="Please select date.">
                                        <div class="input-group-addon">
                                            <a href="#"><i class="entypo-calendar"></i></a>
                                        </div>
                                    </div>
