...
<script>
    $(document).ready(function () {
        $('#addkpmaster_form').submit(function (e) {
            e.preventDefault();
            var formdata = {
                add_kpmaster_department: $('#add_kpmaster_department').val(),
                add_kpmaster_testname: $('#add_kpmaster_testname').val(),
                add_kpmaster_enable_date: $('#add_kpmaster_enable_date').val(),
                add_kpmaster_duration_time: $('#add_kpmaster_duration_time').val(),
                iprquestionfile: $('#iprquestionfile').val()                
            };
            $.ajax({
                url: "<?php echo site_url('Ipr/add_kpmaster') ?>",
                type: 'post',
...
<!-- Upload IPR Master Import question End here-->
                    ...
                    <table class="table table-bordered datatable" id="iprmaster_table">
                        ...
                        <tbody>
                            ...
                            foreach ($q->Result() as $row) {
                                ...
                                // Department Name get value Start
            ...
            <div class="modal-dialog" style="width: 65%">
                <div class="modal-content">
                    <div class="modal-header info-bar">
                        ...
                        <h3 class="modal-title">New Test Name</h3>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <!--<input type="text" name="add_kpmaster_duration_time" id="add_kpmaster_duration_time" placeholder="Duration Time" class="form-control timepicker" data-template="dropdown" data-show-seconds="true" data-default-time="" data-show-meridian="true" data-minute-step="5" data-second-step="5" data-validate="required" data-message-required="Duration Time" />-->
                                        <input type="text" class="form-control" data-mask="datetime12" name="add_kpmaster_duration_time" id="add_kpmaster_duration_time" data-validate="required" data-message-required="Duration Time" />                                        
                                        
                                    </div>	
                                </div>                                
                                <div class="col-md-3">
                                    <label class="control-label">Question Import</label>
                                    <!--<input type="file" name="iprquestionfile" id="iprquestionfile" class="form-control file2 inline btn btn-primary" accept="image/*" data-label="<i class='glyphicon glyphicon-file'></i> Browse"/>-->
