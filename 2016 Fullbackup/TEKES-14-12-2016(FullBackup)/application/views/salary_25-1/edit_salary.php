...
foreach ($q_salary->result() as $row_salary) {
    ...
    $Net_Salary = $row_salary->Net_Salary;
    ...
    $(document).ready(function () {
        $('#editsalary_form').submit(function (e) {
            ...
            var formdata = {
                ...
                edit_salary_Netsalary: $('#edit_salary_Netsalary').val(),
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" name="edit_salary_CCTC" id="edit_salary_CCTC" class="form-control" data-validate="required" data-message-required="Please enter current CTC." value="<?php echo $C_CTC; ?>">
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" name="edit_salary_MonthlyCTC" id="edit_salary_MonthlyCTC" class="form-control" data-validate="required" data-message-required="Please enter monthly CTC." value="<?php echo $Monthly_CTC; ?>">
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" name="edit_salary_Netsalary" id="edit_salary_Netsalary" class="form-control" data-validate="required" data-message-required="Please enter net salary." value="<?php echo $Net_Salary; ?>">
                </div>
            </div>
        </div>
        <div class="col-md-3">
