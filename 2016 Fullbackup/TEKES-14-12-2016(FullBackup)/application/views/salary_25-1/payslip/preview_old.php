...
if ($count_payslip != 0) {
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="col-sm-5" style="margin-left:-60px;margin-top:27px;margin-bottom:15px">
                <p>
                    ...
                    Tel: 080 65691244 , Email : info@drnds.com
                </p>
            </div>
            ...
            <table class="table table-bordered" border="1">
                ...
                <tbody>                                
                    <tr>
                        ...
                        <td><p class="pull-right"><?php echo $Emp_FirstName . " " . $Emp_LastName . " " . $Emp_Middlename; ?></p></td>
                        <td><b>No. of Days worked : </b></td>
                        <td><p class="pull-right"><?php echo $No_Of_Days_Worked; ?> Days</p></td>                                                                                                    </tr>
                    <tr>
                        <td><b>Employee Code : </b></td>
                        <td><p class="pull-right"><?php echo $emp_code . $Emp_Id; ?></p></td>
                        <td><b>No. of Days LOP : </b></td>
                        <td><p class="pull-right"><?php echo $No_Of_Days_LOP; ?></p></td>                                                                        
                    </tr>
                    <tr>
                        <td><b>Designation :</b></td>
                        <td><p class="pull-right"><?php echo $designation_name; ?></p></td>
                        <td><b>PF No : </b></td>
                        <td><p class="pull-right"><?php echo $Emp_PFno; ?></p></td>                                                                        
                    </tr>
                    <tr>
                        <td><b>Date of Joining :</b></td>
                        <td><p class="pull-right"><?php echo $doj; ?></p></td>
                        <td><b>UAN No :</b></td>
                        <td><p class="pull-right"><?php echo $Emp_UANno; ?></p></td>                                                                        
                    </tr>
                    <tr>
                        <td><b>Department :</b></td>
                        <td><p class="pull-right"><?php echo $department_name; ?></p></td>
                        <td><b>ESIC No :</b></td>
                        <td><p class="pull-right"><?php echo $Emp_ESI; ?></p></td>                                                                        
                    </tr>
                    <tr>
                        <td><b>Pan Card No : </b></td>
                        <td><p class="pull-right"><?php echo $Emp_PANcard; ?></p></td>
                        <td><b>Bank Account No :</b></td>
                        <td><p class="pull-right"><?php echo $Emp_Accno; ?></p></td>                                                                        
                    </tr>                                    
                </tbody>
            </table>
        </div>
    ...
    <table class="table table-bordered datatable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><p class="pull-right"><?php echo $Net_Amount; ?></p></td>                                                                        
            </tr>                                                    
        </tbody>                         
    </table>
    <div class="row">
